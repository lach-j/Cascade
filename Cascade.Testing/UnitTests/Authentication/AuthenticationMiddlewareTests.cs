...
namespace Cascade.Testing.UnitTests.Authentication;
...
public class AuthenticationMiddlewareTests
{
    ...
    public async Task InvokeAsync_WhenRequireAuthenticationIsFalse_CallsNext()
    {
        ...
        var middleware = new CascadeAuthenticationMiddleware(next);
        var context = new DefaultHttpContext();
        var serviceProvider = new ServiceCollection().BuildServiceProvider();
        var options = new CascadeOptions { RequireAuthentication = false };
    ...
    public async Task InvokeAsync_WhenRequireAuthenticationIsTrueAndNoAuthProvider_ReturnsInternalServerError()
    {
        ...
        var context = new DefaultHttpContext();
        var serviceProvider = new ServiceCollection().BuildServiceProvider();
        var options = new CascadeOptions { RequireAuthentication = true };
